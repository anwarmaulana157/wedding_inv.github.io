    ...
    <style>
      ...
      @media (max-width: 768px) {
        ...
        .d-flex.overflow-auto {
          -webkit-overflow-scrolling: touch; /* untuk mobile */
        }
      }
    </style>
  </head>
  ...
  <body>
    ...
    <section class="py-5 text-center" id="rsvp" style="background-image: url('assets/images/images4.jpg'); background-size: cover; background-position: center; position: relative">
      ...
      <div class="container position-relative text-white" style="z-index: 2; max-width: 600px">
        ...
        <form action="https://example.com/submit-rsvp" method="POST" class="p-4 rounded-4 shadow" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px)">
          <div class="mb-3 text-start">
            <label for="name" class="form-label fw-semibold">Nama:</label>
            <input type="text" class="form-control bg-light bg-opacity-50 border-0 text-dark" id="name" name="name" placeholder="Nama lengkap" required />
          </div>

          <div class="mb-3 text-start">
            <label for="attendance" class="form-label fw-semibold">Kehadiran:</label>
            <select class="form-select bg-light bg-opacity-50 border-0 text-dark" id="attendance" name="attendance" required>
          ...
          <div class="mb-3 text-start">
            ...
            <textarea class="form-control bg-light bg-opacity-50 border-0 text-dark" id="message" name="message" rows="3" placeholder="Pesan atau doa untuk pengantin"></textarea>
          </div>
